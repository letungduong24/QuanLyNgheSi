                        ...
                        <thead class="bg-gray-100">
                            <tr class="">
                                ...
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                    Tên nghệ sĩ</th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Giải pháp
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="my-auto">
                                            <h6 class="mb-0 text-sm">{{ $artist->ID }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-normal mb-0">{{ $artist->NAME }}</p>
                                </td>
                                <td>
                                    <span class="text-sm font-weight-normal">{{ $artist->MESSAGE }}</span>
                                </td>
                            </tr>
                            @endforeach
                        @else

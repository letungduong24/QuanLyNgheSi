                        ...
                        <thead class="bg-gray-100">
                            <tr class="">
                                ...
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                    Tên lịch trình</th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Thời gian
                                </th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Ngày còn lại
                                </th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Kiểm tra
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="my-auto">
                                            <h6 class="mb-0 text-sm">{{ $schedule->ID }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-normal mb-0">{{ $schedule->NAME }}</p>
                                </td>
                                <td>
                                    <span class="text-sm font-weight-normal">{{ $schedule->TIME }}</span>
                                </td>
                                <td>
                                    <span class="text-sm font-weight-normal">{{ $schedule->REMAIN_TIME }}</span>
                                </td>
                                <td>
                                    <span class="text-sm font-weight-normal">{{ $schedule->SCHEDULE_STATUS }}</span>
                                </td>
                            </tr>
                            @endforeach
                        @else

                        ...
                        <thead class="bg-gray-100">
                            <tr class="">
                                ...
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">
                                    Tên nghệ sĩ</th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Số bài hát
                                </th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Số lịch trình
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div class="my-auto">
                                            <h6 class="mb-0 text-sm">{{ $activitiy->ID }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-normal mb-0">{{ $activitiy->NAME }}</p>
                                </td>
                                <td>
                                    <span class="text-sm font-weight-normal">{{ $activitiy->COUNTSONG }}</span>
                                </td>
                                <td>
                                    <span class="text-sm font-weight-normal">{{ $activitiy->COUNTSCHEDULE }}</span>
                                </td>
                            </tr>
                            @endforeach
                        @else

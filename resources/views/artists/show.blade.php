                    ...
                    <div class="col-lg-9 col-12 ">
                        <div class="card " id="basic-info">
                            ...
                            <table class="table align-items-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">Mã lịch trình
                                            </th>
                                            <th class="d-flex justify-content-center text-secondary text-xs font-weight-semibold opacity-7">
                                                Tên lịch trình</th>
                                            <th class=" text-secondary text-xs font-weight-semibold opacity-7">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="d-flex justify-content-center text-sm text-dark font-weight-semibold mb-0 ">{{$schedule->SCHEDULE_ADDRESS}}</p>
                                            </td>
                                            <td>
